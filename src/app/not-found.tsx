...
const NotFound = () => {
  return (
    <div className="bg-rsd-dark-blue flex h-screen w-screen flex-col items-center justify-center">
      <Image src={cloud} alt="cloud" className="mr-120 w-1/4" />
      ...
      <Button
        asChild
        className="bg-rsd-mid-blue/40 flex h-1/15 w-1/7 rounded-full text-2xl shadow-xl hover:bg-gray-600"
      >
        <Link href="/">Go Back Home</Link>
      </Button>
      <Image src={cloud} alt="cloud" className="ml-120 w-1/4" />
    </div>
  );
};
