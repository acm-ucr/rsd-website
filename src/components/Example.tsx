  ...
  return (
    <div className="flex w-3/4 items-center gap-1 bg-red-200 p-10">
      ...
      <div className="flex w-1/2 flex-row gap-1">
        <div className="w-full font-rsd-alt bg-green-200 p-5 text-left">props.text2</div>
        <div className="w-full font-rsd-main bg-green-200 p-5 text-right">{props.text2}</div>
      </div>
