    ...
    <div className="flex flex-col items-center overflow-hidden">
      ...
      <div className="relative flex justify-center">
        <motion.div
          ...
          className="absolute top-[15%] left-[8%] size-10 md:size-20"
        >
        ...
        <motion.div
          ...
          initial={{ opacity: 0, x: 0 }}
          whileInView={{ opacity: 1, x: 0, rotate: 360 }}
          className="absolute right-[8%] bottom-[12%] size-10 md:size-20"
        >
          <Image src={Star4Point} alt="Four Point Star" />
        </motion.div>
        ...
        <InfoBox
          text={
            <ul className="marker:text-rsd-gold w-[40vw] list-outside list-disc">
