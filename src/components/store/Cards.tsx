  ...
  return (
    <div className="relative flex w-screen flex-col items-center justify-center overflow-hidden">
      ...
      <motion.div
        ...
        className="flex flex-col items-center justify-center pt-4 md:pt-0 xl:flex-row"
      >
        <ProductCard productName="Jersey(men's)" productPrice="$17.99" />
        <ProductCard productName="Jersey(women's)" productPrice="$17.99" />
        <ProductCard productName="Jacket" productPrice="$29.99" />
      </motion.div>
      <div className="relative flex w-screen items-center justify-center pt-[10vh] md:pb-[22vh]">
        <motion.div
          transition={{
            duration: 1,
            delay: 0.5,
