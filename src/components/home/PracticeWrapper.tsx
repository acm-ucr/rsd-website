      ...
      <div className = "bg-rsd-title-blue xl:bg-transparent">
        <div className="relative w-full">
          <Image
            src={Wave}
            alt="Wave"
            className="absolute -z-10 hidden h-full w-full object-fill xl:flex lg:h-fit xl:-top-[18vh] 2xl:-top-[8vh]"
          />
          <div className="flex flex-col flex-wrap px-8 md:items-center md:flex-row md:flex-nowrap xl:items-stretch xl:px-10 xl:py-10">
            ...
            <div className="flex items-center justify-center md:w-1/3">
              <InfoBox
                text={
                  <ul className="flex list-outside list-[square] flex-col marker:text-4xl marker:text-white xl:gap-4 pl-8 md:pl-10">
                    <li>Sunscreen</li>
                    <li>Water</li>
        ...
        <div className="flex flex-col items-center">
          ...
          <motion.div whileHover={{ scale: 1.05 }} className="p-10 2xl:pt-40">
            <Button className="bg-rsd-gold hover:bg-rsd-yellow font-rsd-alt rounded-full p-8 text-center text-3xl font-bold text-black xl:p-16 2xl:p-32 xl:text-5xl 2xl:text-7xl">
