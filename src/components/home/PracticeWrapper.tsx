...
const PracticeWrapper = () => {
  return (
    <div className="flex h-screen w-screen flex-col">
      <div className="relative flex justify-center font-normal">
        <Header text="Practice Info" />
      </div>
      <Image src={Wave} alt="Wave" className="absolute z-0 flex w-full" />
      <div className="relative z-10 flex flex-row items-start justify-evenly rounded-full">
          ...
          <InfoBox
            text={
              <div className="p-4 text-left text-3xl">
                <ul className="flex list-[square] flex-col items-start gap-5 text-center marker:text-3xl marker:text-white">
                  <li>Sunscreen</li>
                  <li>Water</li>
