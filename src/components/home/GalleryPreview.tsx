...
const GalleryPreview = () => {
  ...
  return (
    <div className="flex-wrap">
      ...
      >
        <CarouselPrevious />
        <CarouselContent className = "w-[95vw] relative">
            ...
            <CarouselItem
              ...
              className={`lg:basis-1/3
                        ${(current === (index - 1 + totalSlides) % totalSlides || 
                          ...
                          current === index) ? "visible flex justify-center" : "invisible"}
                          `}>
                <Card className ={`bg-rsd-yellow w-11/12 ${current === index ? "scale-[100%]" : "scale-[75%]"}`}>
